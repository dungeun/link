  ...
  try {
    ...
    const homePageTexts = [
      ...
      },
      {
        ...
        ja: 'ブランドとインフルエンサーを繋ぐ革新的なプラットフォーム',
        category: 'homepage',
      ...
      },
      {
        ...
        ja: 'ブランドでもインフルエンサーでも、あなたの成功ストーリーを作ってみてください',
        category: 'homepage',
    ...
    const campaignsPageTexts = [
      ...
      },
      {
        ...
        ja: 'プロフィールを登録すると、カスタマイズされたキャンペーンの推薦を受けることができます。',
        category: 'campaigns',
        description: 'CTA 섹션 부제목'
      },
      {
