...
function getOptimizedDatabaseUrl(): string {
  ...
  url.searchParams.set(
    "connection_limit",
    String(CONNECTION_POOL_CONFIG.connection_limit),
  );
  url.searchParams.set(
    "connect_timeout",
    String(CONNECTION_POOL_CONFIG.connect_timeout),
  );
  url.searchParams.set(
    "pool_timeout",
    String(CONNECTION_POOL_CONFIG.pool_timeout),
  );
  url.searchParams.set(
    "idle_in_transaction_session_timeout",
    String(CONNECTION_POOL_CONFIG.idle_in_transaction_session_timeout),
  );
...
function createPrismaClient() {
  ...
  client.$use(async (params, next) => {
    ...
    if (
      ...
      console.warn(
        `[WARNING] Large dataset query: ${params.model}.findMany with take=${params.args.take}`,
      );
    }
