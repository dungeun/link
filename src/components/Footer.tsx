...
function Footer() {
  ...
  const footerEnabled = useMemo(
    () =>
      siteSettings.website?.footerEnabled ??
      websiteSettings?.footerEnabled ??
      true,
  ...
  const filteredColumns = columns
    ?.filter(
      (col) =>
        !col.title?.includes("service") && !col.title?.includes("서비스"),
    )
                  ...
                  : social
                      ...
                      .map((socialItem, index) => (
                        ...
                        >
                          {
                            socialIcons[
                              socialItem.platform as keyof typeof socialIcons
                            ]
                          }
                        </a>
                      ))}
                ...
                <div className="grid grid-cols-2 gap-6 text-sm">
                  ...
                  <div className="text-gray-400 space-y-2">
                    ...
                    <div className="flex flex-wrap gap-x-4 gap-y-1 text-xs">
                      ...
                      <span>
                        {t("footer.info.businessNo", "사업자등록번호")}:
                        123-45-67890
                      </span>
                    </div>
                    <div className="text-xs">
                      <span>
                        {t("footer.info.telecom", "통신판매업")}:
                        2024-서울강남-1234
                      </span>
                    </div>
                  ...
                  <div className="text-gray-400 space-y-2">
                    ...
                    <div className="text-xs space-y-1">
                      <div className="flex items-center gap-1">
                        ...
                        <span>
                          {siteSettings.general?.supportEmail ||
                            "support@linkpick.com"}
                        </span>
                      </div>
                      ...
                      <p className="text-xs text-gray-500">
                        {(() => {
                          ...
                          return (
                            ...
                            t(
                              copyright,
                              `© ${new Date().getFullYear()} LinkPick. All rights reserved.`,
                            )
                          );
                        })()}
                      </p>
                          ...
                          >
                            {(() => {
                              ...
                              if (typeof title === "object" && title) {
                                return (
                                  title[currentLanguage] || title.ko || title.en
                                );
                              }
                              return title || "";
                            })()}
                  ...
                  <ul className="space-y-3">
                    ...
                    <li>
                      <Link
                        ...
                        className="text-gray-400 hover:text-cyan-400 transition-colors duration-200 text-sm"
                      >
                        {t("footer.legal.privacy", "개인정보처리방침")}
                      </Link>
                    </li>
                  </ul>
                </div>
