...
export default function BankingInfo({
  ...
  const [accountType, setAccountType] = useState<"domestic" | "international">(
    initialData?.accountType || "domestic",
  );
  const [data, setData] = useState({
    ...
    international: {
      ...
      englishAddress: {
        ...
        postalCode:
          initialData?.international?.englishAddress?.postalCode || "",
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleDomesticChange("bankName", e.target.value)
                  }
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleDomesticChange("accountNumber", e.target.value)
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleDomesticChange("accountHolder", e.target.value)
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500"
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInternationalChange("englishName", e.target.value)
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInternationalChange("accountNumber", e.target.value)
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500"
              ...
              <div>
                ...
                <div className="space-y-2">
                  <input
                    ...
                    onChange={(e) =>
                      handleInternationalChange("street", e.target.value, true)
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500"
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <input
                      ...
                      onChange={(e) =>
                        handleInternationalChange("city", e.target.value, true)
                      }
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInternationalChange("country", e.target.value, true)
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500"
                    placeholder="Country"
                  />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInternationalChange("swiftCode", e.target.value)
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleInternationalChange("branchCode", e.target.value)
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500"
                  placeholder="미국 은행의 경우 ABA/Routing Number"
                />
                <p className="mt-1 text-xs text-gray-500">
                  미국 은행의 경우 9자리 라우팅 번호, 다른 국가는 해당 코드 입력
                </p>
              </div>
            </div>
          )}
