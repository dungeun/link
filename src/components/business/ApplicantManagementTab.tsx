...
export default function ApplicantManagementTab({ campaign }: Props) {
  ...
  const [activeTab, setActiveTab] = useState<"basic" | "sns" | "intro">(
    "basic",
  );
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast({
          title: "오류",
          description:
            errorData.error || "지원자 목록을 불러오는데 실패했습니다.",
          variant: "destructive",
        });
      }
    } catch (error) {
  ...
  const handleStatusChange = async (
    ...
    try {
      ...
      const response = await apiPost(
        `/api/business/campaigns/${campaignId}/applicants/${applicantId}/status`,
        {
          status,
        },
      );
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-2xl font-bold">
                    {selectedApplicant.influencerName}
                  </h3>
                  <p className="text-gray-500">
                    @{selectedApplicant.influencerHandle || "N/A"}
                  </p>
                  <div className="mt-2">
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <a
                                href={`https://instagram.com/${selectedApplicant.influencer.profile.instagram.replace("@", "")}`}
                                target="_blank"
                          ...
                          <div className="text-right">
                            <p className="text-2xl font-bold">
                              {selectedApplicant.influencer.profile.instagramFollowers?.toLocaleString() ||
                                0}
                            </p>
                    ...
                    {selectedApplicant.influencer?.profile?.youtube && (
                      <div className="border border-gray-200 rounded-lg p-4">
                        <div className="flex items-start justify-between">
                          ...
                          <div className="text-right">
                            <p className="text-2xl font-bold">
                              {selectedApplicant.influencer.profile.youtubeSubscribers?.toLocaleString() ||
                                0}
                            </p>
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-gray-600">
                                @
                                {selectedApplicant.influencer.profile.tiktok.replace(
                                  "@",
                                  "",
                                )}
                              </p>
                          ...
                          <div className="text-right">
                            <p className="text-2xl font-bold">
                              {selectedApplicant.influencer.profile.tiktokFollowers?.toLocaleString() ||
                                0}
                            </p>
                            <p className="text-sm text-gray-500">팔로워</p>
                          </div>
                    ...
                    {selectedApplicant.influencer?.profile?.facebook && (
                      <div className="border border-gray-200 rounded-lg p-4">
                        <div className="flex items-start justify-between">
                          ...
                          <div className="text-right">
                            <p className="text-2xl font-bold">
                              {selectedApplicant.influencer.profile.facebookFollowers?.toLocaleString() ||
                                0}
                            </p>
                            <p className="text-sm text-gray-500">팔로워</p>
                          </div>
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-gray-600">
                                @
                                {selectedApplicant.influencer.profile.twitter.replace(
                                  "@",
                                  "",
                                )}
                              </p>
                          ...
                          <div className="text-right">
                            <p className="text-2xl font-bold">
                              {selectedApplicant.influencer.profile.twitterFollowers?.toLocaleString() ||
                                0}
                            </p>
                            <p className="text-sm text-gray-500">팔로워</p>
                          </div>
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <a
                                href={
                                  selectedApplicant.influencer.profile.naverBlog.startsWith(
                                    "http",
                                  )
                                    ? selectedApplicant.influencer.profile
                                        .naverBlog
                          ...
                          <div className="text-right space-y-1">
                            <div>
                              <p className="text-xl font-bold">
                                {selectedApplicant.influencer.profile.naverBlogFollowers?.toLocaleString() ||
                                  0}
                              </p>
                              <p className="text-xs text-gray-500">이웃</p>
                            </div>
                            {selectedApplicant.influencer.profile
                              .naverBlogTodayVisitors !== undefined && (
                              <div>
                                <p className="text-lg font-semibold text-green-600">
                                  {selectedApplicant.influencer.profile.naverBlogTodayVisitors.toLocaleString()}
                                </p>
                    ...
                    <div className="bg-indigo-50 rounded-lg p-4">
                      ...
                      <div className="flex items-center gap-4">
                        <div className="text-3xl font-bold text-indigo-600">
                          {selectedApplicant.influencer.profile.averageEngagementRate.toFixed(
                            2,
                          )}
                          %
                        </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      <p className="font-medium text-lg mb-2">
                        {selectedApplicant.campaignTitle}
                      </p>
                      <p className="text-sm text-gray-600">
                        캠페인 ID: {selectedApplicant.campaignId}
                      </p>
                    </div>
                  </div>
                </div>
