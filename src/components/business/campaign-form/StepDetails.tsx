        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              선정된 인플루언서를 발표할 날짜입니다. 캠페인 시작일 이전이어야
              합니다.
            </p>
          </div>
        </div>
            ...
            <div>
              ...
              <div className="relative mt-1">
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, contentEndDate: e.target.value })
                  }
                  min={
                    formData.contentStartDate ||
                    formData.announcementDate ||
                    new Date().toISOString().split("T")[0]
                  }
                />
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <Textarea
              ...
              onChange={(e) =>
                setFormData({ ...formData, provisionDetails: e.target.value })
              }
          ...
          <div>
            ...
            <Textarea
              ...
              onChange={(e) =>
                setFormData({ ...formData, campaignMission: e.target.value })
              }
