...
import { X, Save, Building2, Calendar, DollarSign, Users, Image, FileText, Hash } from 'lucide-react'
...
export default function CampaignEditModal({ 
  ...
  const fetchCampaignDetail = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setBusinessFormData({...(campaignData.business?.businessProfile || {})})
  ...
  const handleSaveCampaign = async () => {
    ...
    try {
      ...
      // 빈 문자열이면 null로 처리
      const businessIdToSend = finalBusinessId && finalBusinessId.trim() !== '' ? finalBusinessId : null
      ...
      console.log('업체 변경 여부:', businessIdToSend !== campaign?.business?.id)
      
      const response = await adminApi.put(`/api/admin/campaigns/${campaignId}`, updateData)
  ...
  const handleSaveBusiness = async () => {
    ...
    try {
      setSaving(true)
      const response = await adminApi.put(`/api/admin/business/${selectedBusinessId}`, {
  ...
  return (
    <>
      ...
      {/* 슬라이드 패널 */}
      <div className={`fixed right-0 top-0 h-full w-full max-w-4xl bg-white shadow-2xl transform transition-transform duration-300 z-[9999] ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        {/* 헤더 */}
        <div className="relative bg-white border-b border-gray-200 px-6 py-4">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-bold text-gray-900">캠페인 및 업체 정보 수정</h2>
            <button
              onClick={onClose}
        ...
        <div className="overflow-y-auto" style={{ height: 'calc(100% - 80px)' }}>
          ...
          {loading ? (
            ...
            <div className="p-6 text-center text-red-600">캠페인 정보를 불러올 수 없습니다.</div>
          ) : campaign && (
            <>
              {/* 캠페인 정보 탭 */}
              {activeTab === 'campaign' && (
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => handleInputChange('targetFollowers', parseInt(e.target.value))}
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => handleInputChange('platformFeeRate', parseFloat(e.target.value) / 100)}
                          min="0"
                          max="100"
                          step="0.1"
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          type="date"
                          value={formData.applicationStartDate?.split('T')[0] || ''}
                      ...
                      <div>
                        ...
                        <input
                          type="date"
                          value={formData.applicationEndDate?.split('T')[0] || ''}
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={(e) => handleInputChange('provisionDetails', e.target.value)}
                        rows={3}
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={(e) => handleInputChange('campaignMission', e.target.value)}
                        rows={3}
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      />
                    </div>
                        ...
                        onChange={(e) => {
                          ...
                          if (newBusinessId && newBusinessId.trim() !== '') {
                            ...
                            if (selectedBusiness?.businessProfile) {
                              console.log('업체 프로필 로드:', selectedBusiness.businessProfile)
                              setBusinessFormData({...selectedBusiness.businessProfile})
                            } else {
                              console.log('업체 프로필 없음 - 기본값으로 초기화')
                              setBusinessFormData({})
                            }
                          } else {
                      ...
                      >
                        ...
                        {businesses.map((business) => (
                          <option key={business.id} value={business.id}>
                            {business.name} ({business.email}) - {business.businessProfile?.companyName || '회사명 없음'}
                          </option>
                        ))}
                      </select>
                    ) : (
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => handleBusinessInputChange('businessNumber', e.target.value)}
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => handleBusinessInputChange('representativeName', e.target.value)}
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) => handleBusinessInputChange('businessCategory', e.target.value)}
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        >
                ...
                <div className="p-6 space-y-6">
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      />
                      {formData.imageUrl && (
                        <img src={formData.imageUrl} alt="메인 이미지" className="mt-2 h-32 object-cover rounded" />
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      {formData.headerImageUrl && (
                        <img src={formData.headerImageUrl} alt="헤더 이미지" className="mt-2 h-32 object-cover rounded" />
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      {formData.thumbnailImageUrl && (
                        <img src={formData.thumbnailImageUrl} alt="썸네일 이미지" className="mt-2 h-32 object-cover rounded" />
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={(e) => handleInputChange('productImages', e.target.value)}
                        rows={4}
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={(e) => handleInputChange('detailImages', e.target.value)}
                        rows={4}
