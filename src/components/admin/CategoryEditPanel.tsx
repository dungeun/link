...
export default function CategoryEditPanel({
  ...
  const getSubCategories = () => {
    ...
    return subCategories.filter(
      (sub) => sub.mainCategory === selectedMainCategory,
    );
  };
              ...
              {campaign && (
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-600 mb-1">
                    <strong>제목:</strong> {campaign.title}
                  </p>
                  <p className="text-sm text-gray-600">
                    <strong>업체:</strong>{" "}
                    {(campaign as any).businessName || "N/A"}
                  </p>
                </div>
              )}
              ...
              <div className="bg-blue-50 rounded-lg p-4">
                ...
                <div className="space-y-1">
                  <p className="text-sm text-blue-800">
                    <strong>대분류:</strong>{" "}
                    {selectedMainCategory || "선택되지 않음"}
                  </p>
                  <p className="text-sm text-blue-800">
                    <strong>중분류:</strong>{" "}
                    {selectedSubCategory || "선택되지 않음"}
                  </p>
                </div>
              </div>
            </>
