...
export default function PaymentDetailPanel({
  ...
  return (
    <>
      ...
      {/* 슬라이드 패널 */}
      <div
        className={`fixed right-0 top-0 h-full w-[600px] bg-white shadow-xl z-50 transform transition-transform ${
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  {/* 인플루언서 정보 (정산인 경우) */}
                  {payment.type === "INFLUENCER_SETTLEMENT" &&
