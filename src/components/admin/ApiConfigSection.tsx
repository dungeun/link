  ...
  const handleTest = async (service: string) => {
    ...
    try {
      ...
      if (response.ok && data.success) {
        alert(
          `✅ ${getServiceInfo(service)?.label} API 연결 테스트 성공!\n\n${data.message || "정상적으로 연결되었습니다."}`,
        );
      } else {
        alert(
          `❌ ${getServiceInfo(service)?.label} API 연결 테스트 실패\n\n${data.error || "연결에 실패했습니다."}`,
        );
      }
    } catch (error) {
      alert(
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
        {API_SERVICES.map((serviceInfo) => {
          ...
          return (
            <div
              key={service}
              className={`bg-white p-6 rounded-lg shadow border-2 transition-all ${
                isConfigured
                ...
                <div className="text-center py-8">
                  ...
                  <button
                    onClick={() => {
                      ...
                      setChangedServices(
                        new Set([...changedServices, service]),
                      );
                    }}
                ...
                <>
                  <div className="flex items-center gap-2 mb-4">
                    <label className="flex items-center cursor-pointer">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          updateConfig(service, "isEnabled", e.target.checked)
                        }
                        className="sr-only"
                      />
                      <div className="relative">
                        <div
                          className={`block w-10 h-6 rounded-full transition-colors ${config.isEnabled ? "bg-blue-600" : "bg-gray-300"}`}
                        ></div>
                        <div
                          className={`absolute left-1 top-1 bg-white w-4 h-4 rounded-full transition-transform ${config.isEnabled ? "translate-x-4" : ""}`}
                        ></div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <input
                            ...
                            value={config.apiKey || ""}
                            onChange={(e) =>
                              updateConfig(service, "apiKey", e.target.value)
                            }
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <input
                            ...
                            onChange={(e) =>
                              updateConfig(service, "apiSecret", e.target.value)
                            }
                            className="w-full px-4 py-2 pr-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                    ...
                    {serviceInfo.fields.includes("endpoint") && (
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            updateConfig(service, "endpoint", e.target.value)
                          }
                    ...
                    {serviceInfo.fields.includes("region") && (
                      <div>
                        ...
                        <input
                          ...
                          value={config.region || ""}
                          onChange={(e) =>
                            updateConfig(service, "region", e.target.value)
                          }
                          className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                    ...
                    {serviceInfo.fields.includes("bucket") && (
                      <div>
                        ...
                        <input
                          ...
                          value={config.bucket || ""}
                          onChange={(e) =>
                            updateConfig(service, "bucket", e.target.value)
                          }
                          className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                  ...
                  <div className="flex items-center gap-2 mt-6 pt-4 border-t">
                    ...
                    <button
                      ...
                      disabled={
                        saving === service || !changedServices.has(service)
                      }
