      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button variant="outline" size="sm" onClick={loadHomepageData}>
        ...
        <CardContent>
          <div className="text-xs text-gray-500 space-y-1">
            <p>
              마지막 업데이트:{" "}
              {new Date(homepageData.metadata.lastUpdated).toLocaleString(
                "ko-KR",
              )}
            </p>
            <p>
              순서 변경:{" "}
              {new Date(homepageData.metadata.orderedAt).toLocaleString(
                "ko-KR",
              )}
            </p>
          </div>
