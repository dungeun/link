...
import { Users, Heart, Share2, Instagram, Youtube } from "lucide-react";
    ...
    <>
      ...
      <div className="bg-white shadow-lg border border-gray-100 mx-6 -mt-20 relative z-10 rounded-2xl">
        <div className="p-8">
                  ...
                  {(campaign.platforms || []).map(
                    (platform: any, index: number) => {
                      ...
                      return (
                        <span
                          key={index}
                          className="flex items-center gap-1 text-gray-600 bg-gray-50 px-3 py-1 rounded-full"
                        >
          ...
          {/* 비즈니스 정보 */}
          <Link
            href={`/business/${campaign.business?.id || ""}`}
