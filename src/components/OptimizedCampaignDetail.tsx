...
const OptimizedCampaignDetail = memo(
  ({
    ...
    const applicationRate = useMemo(() => {
      ...
      return Math.min(
        100,
        (campaign.applicationCount / campaign.maxApplicants) * 100,
      );
        ...
        <div className="relative h-64 md:h-96 rounded-2xl overflow-hidden bg-gray-100 mb-8">
          {campaign.headerImageUrl ? (
            <Image
              ...
              unoptimized={campaign.headerImageUrl.includes(
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm sticky top-4">
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span
                    className={`font-bold ${dateInfo.daysLeft <= 3 ? "text-red-500" : ""}`}
                  >
                    D-{dateInfo.daysLeft}
                  </span>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">
                    {campaign.targetFollowers?.toLocaleString()}명
                  </span>
                </div>
                    ...
                    <div className="relative aspect-square bg-gray-100">
                      {related.thumbnailImageUrl && (
                        <Image
                          ...
                          unoptimized={related.thumbnailImageUrl.includes(
                            "blob.vercel-storage.com",
                          )}
                        />
                      )}
