    ...
    const profile = await prisma.profile.upsert({
      ...
      update: {
        ...
        instagramFollowers: instagramFollowers
          ? parseInt(instagramFollowers)
          : undefined,
        youtube,
        youtubeSubscribers: youtubeSubscribers
          ? parseInt(youtubeSubscribers)
          : undefined,
        tiktok,
        tiktokFollowers: tiktokFollowers
          ? parseInt(tiktokFollowers)
          : undefined,
        naverBlog,
        naverBlogFollowers: naverBlogFollowers
          ? parseInt(naverBlogFollowers)
          : undefined,
