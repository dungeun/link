    ...
    business: [
      {
        ...
        notIncluded: ["AI 매칭 추천", "고급 분석 리포트", "전담 매니저"],
      },
      {
        name: "Professional",
    ...
    influencer: [
      {
        ...
        notIncluded: ["우선 매칭", "성장 분석", "교육 콘텐츠"],
      },
      {
        name: "Pro",
  ...
  const faqs = [
    {
      ...
      answer:
        "네, 모든 유료 플랜은 14일 무료 체험이 가능합니다. 신용카드 등록 없이 바로 시작할 수 있습니다.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "브랜드는 월 구독료만 지불하며, 인플루언서는 캠페인 성사 시 수수료를 지불합니다. Basic 플랜은 15%, Pro 플랜은 10%입니다.",
    },
    {
      question: "환불 정책은 어떻게 되나요?",
      answer:
        "구독 시작 후 7일 이내 100% 환불이 가능합니다. 연간 결제의 경우 사용하지 않은 기간에 대해 일할 계산하여 환불해드립니다.",
    },
    {
      question: "Enterprise 플랜 견적은 어떻게 받나요?",
      answer:
        "문의하기를 통해 귀사의 요구사항을 알려주시면, 맞춤형 견적을 제공해드립니다.",
    },
  ];
                ...
                <div className="p-8">
                  ...
                  <div className="mb-6">
                    <div className="text-4xl font-bold">
                      {plan.monthlyPrice === 0
                        ? "무료"
                        : `₩${(billingCycle === "monthly" ? plan.monthlyPrice : plan.yearlyPrice / 12).toLocaleString()}`}
                    </div>
                    {plan.monthlyPrice !== 0 && (
                      <div className="text-gray-500">
        ...
        <div className="container mx-auto px-6 max-w-3xl">
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <div
                key={index}
                className="faq-item bg-white rounded-lg shadow-sm overflow-hidden animate-in fade-in slide-in-from-left-4 duration-600"
