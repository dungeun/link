      ...
      <section className="relative pt-32 pb-20 bg-gradient-to-br from-slate-900 via-blue-900 to-cyan-900">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center text-white hero-content">
            ...
            <p
              className="text-xl text-white/80 mb-8 animate-in fade-in slide-in-from-bottom-4 duration-800"
              style={{ animationDelay: "200ms" }}
            >
              LinkPick은 AI 기술과 데이터 분석을 통해 브랜드와 인플루언서를
              연결하는 혁신적인 리뷰 마케팅 플랫폼입니다.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div
                className="text-center mission-item animate-in fade-in slide-in-from-bottom-4 duration-600"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg mx-auto">
              <p className="text-gray-700 mb-6">
                2024년, 인플루언서 마케팅 시장의 불투명성과 비효율성을
                해결하고자 LinkPick이 탄생했습니다. 우리는 브랜드가 적합한
                인플루언서를 찾기 어렵고, 인플루언서가 공정한 대우를 받지 못하는
                현실을 목격했습니다.
              </p>
              <p className="text-gray-700 mb-6">
                AI 기술과 빅데이터 분석을 결합하여, 우리는 양측 모두에게 이익이
                되는 플랫폼을 만들었습니다. 투명한 가격 정책, 정확한 성과 측정,
                그리고 안전한 거래 시스템을 통해 인플루언서 마케팅의 새로운
                표준을 제시하고 있습니다.
              </p>
              <p className="text-gray-700">
                현재 50,000명 이상의 인플루언서와 2,500개 이상의 브랜드가
                LinkPick을 통해 성공적인 캠페인을 진행하고 있으며, 매달 30%
                이상의 성장을 기록하고 있습니다.
              </p>
            </div>
          </div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white p-8 rounded-2xl shadow-lg value-card animate-in fade-in slide-in-from-bottom-4 duration-600">
                ...
                <p className="text-gray-600">
                  모든 거래와 데이터를 투명하게 공개하여 참여자 간의 신뢰를
                  구축합니다. 에스크로 시스템과 검증된 리뷰를 통해 안전한 거래를
                  보장합니다.
                </p>
              </div>
              <div
                className="bg-white p-8 rounded-2xl shadow-lg value-card animate-in fade-in slide-in-from-bottom-4 duration-600"
                style={{ animationDelay: "100ms" }}
              >
                <div className="flex items-center mb-6">
                ...
                <p className="text-gray-600">
                  최신 AI 기술과 데이터 분석을 활용하여 지속적으로 서비스를
                  개선합니다. 사용자 피드백을 적극 반영하여 더 나은 경험을
                  제공합니다.
                </p>
              </div>
              <div
              ...
              >
                ...
                <p className="text-gray-600">
                  모든 참여자에게 공정한 기회를 제공하고, 합리적인 수수료 정책을
                  유지합니다. 크리에이터의 창의성과 브랜드의 가치를 동등하게
                  존중합니다.
                </p>
              </div>
              <div
              ...
              >
                ...
                <p className="text-gray-600">
                  플랫폼 참여자들의 지속적인 성장을 지원합니다. 교육 프로그램,
                  분석 도구, 네트워킹 기회를 제공하여 함께 발전합니다.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div
                className="text-center team-member animate-in fade-in slide-in-from-bottom-4 duration-600"
                style={{ animationDelay: "100ms" }}
              >
                <img
                  src="https://images.unsplash.com/photo-1494790108755-2616c9c3e0e6?w=150&h=150&fit=crop&crop=face"
                  alt="CTO"
                  className="w-32 h-32 rounded-full mx-auto mb-4 object-cover"
                />
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-cyan-600">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-white/80 mb-8">
            LinkPick과 함께 인플루언서 마케팅의 미래를 만들어갑니다.
          </p>
