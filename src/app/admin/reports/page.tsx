      ...
      if (response.ok) {
        ...
        setReports([
          ...
          },
          {
            ...
            evidence: {
              screenshots: [
                "https://example.com/spam1.jpg",
                "https://example.com/spam2.jpg",
              ],
              urls: [],
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredReports.map((report) => (
                <tr key={report.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span
                      className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${getPriorityColor(report.priority)}`}
                    >
