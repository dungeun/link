...
export default function AdminUsersPage() {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setPagination({
          ...
          totalPages:
            data.totalPages ||
            Math.ceil((data.total || data.totalCount || 0) / pagination.limit),
        });
      } else {
  ...
  const filteredUsers = users.filter((user) => {
    if (filters.type !== "all" && user.type.toLowerCase() !== filters.type)
      return false;
    if (
      filters.status !== "all" &&
      user.status.toLowerCase() !== filters.status
    )
      return false;
    if (
      filters.search &&
                        ...
                        <div className="space-y-4">
                          ...
                          <div>
                            ...
                            <input
                              type="text"
                              value={
                                selectedUser.businessProfile.businessNumber
                              }
                              disabled
                              className="mt-1 w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100"
                            />
                          ...
                          <div>
                            ...
                            <input
                              type="text"
                              value={
                                selectedUser.businessProfile.representativeName
                              }
                              disabled
                              className="mt-1 w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100"
                            />
