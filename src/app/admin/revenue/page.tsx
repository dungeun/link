  ...
  const fetchRevenueData = async () => {
    try {
      ...
      const response = await apiGet(
        `/api/admin/revenue?period=${period}&startDate=${dateRange.startDate}&endDate=${dateRange.endDate}`,
      );
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <p className="text-sm text-green-600 mt-2">
              +{revenueData.monthlyGrowth}% 전월 대비
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <p className="text-2xl font-bold text-gray-900">
              {formatCurrency(revenueData.settlementAmount)}
            </p>
              ...
              <div className="pt-4 border-t">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium">
                      {(
                        (revenueData.netProfit / revenueData.totalRevenue) *
                        100
                      ).toFixed(1)}
                      %
                    </span>
