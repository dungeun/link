...
export default function AdminContentPage() {
  ...
  const [activeTab, setActiveTab] = useState<"content" | "community">(
    "content",
  );
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">
            인플루언서가 생성한 콘텐츠와 커뮤니티 게시글을 관리합니다
          </p>
        </div>
                    ...
                    {filteredContents.map((content) => (
                      <tr key={content.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-3 py-3 w-24 text-center">
                          <span
                            className={`px-2 py-1 text-xs font-medium rounded-full ${getStatusColor(content.status)}`}
                          >
                          ...
                          <div className="flex flex-col items-center space-y-1">
                            {content.status === "pending" && (
                              <div className="flex space-x-1">
                                ...
                                <button
                                  onClick={() =>
                                    handleStatusChange(content.id, "rejected")
                                  }
