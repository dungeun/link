...
import { ArrowLeft, Plus, Trash2, Eye, EyeOff, Save, Globe, ChevronUp, ChevronDown } from 'lucide-react';
...
export default function MainPageSectionsPage() {
  ...
  const handleUpdateSection = (id: string, updates: Partial<MainPageSection>) => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      for (const section of sections) {
        const response = await fetch(`/api/admin/ui-sections/${section.sectionId || section.type}`, {
          method: 'PUT',
          headers: {
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">메인 페이지 섹션 관리</h1>
                <p className="text-sm text-gray-600 mt-1">메인 페이지에 표시되는 섹션들을 관리합니다</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <button
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <h3 className="font-semibold text-gray-900">
                          {section.title?.ko || sectionTypes.find(t => t.value === section.type)?.label || section.type}
                        </h3>
                ...
                <div className="mt-4 grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => handleUpdateSection(section.id, { sectionId: e.target.value })}
                      className="w-full px-3 py-1.5 text-sm border rounded-lg focus:ring-2 focus:ring-blue-500"
