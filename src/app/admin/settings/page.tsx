...
export default function AdminSettingsPage() {
  const [settings, setSettings] = useState<SystemSettings>({
    general: {
      siteName: "LinkPick",
      siteDescription:
        "인플루언서 마케팅 플랫폼 - 브랜드와 인플루언서를 연결하는 마케팅 플랫폼",
    ...
    website: {
      ...
      seo: {
        ...
        metaDescription:
          "최고의 인플루언서와 브랜드를 연결하는 마케팅 플랫폼입니다.",
    ...
    seo: {
      ...
      description:
        "브랜드와 인플루언서를 연결하는 혁신적인 마케팅 플랫폼입니다.",
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange("company", "ceo", e.target.value)
                      }
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="text-xs text-gray-600 space-y-1">
                  ...
                  <div>
                    대표: {settings.company.ceo} | 사업자등록번호:{" "}
                    {settings.company.businessNumber}
                  </div>
                  <div>
                    {settings.company.businessType}:{" "}
                    {settings.company.telecomNumber}
                  </div>
                  <div>📍 {settings.company.address}</div>
                  <div>
                    📞 {settings.company.phone} | ✉️ {settings.company.email}
                  </div>
                  ...
                  <div>
                    ...
                    <div className="max-w-xs">
                      <ImageUpload
                        ...
                        onChange={(value) =>
                          handleInputChange("website", "logo", value)
                        }
                        category="temp"
                        maxSize={2}
                        className="w-full"
                  ...
                  <div>
                    ...
                    <div className="max-w-xs">
                      <ImageUpload
                        ...
                        onChange={(value) =>
                          handleInputChange("website", "favicon", value)
                        }
                        category="temp"
                        maxSize={1}
                        className="w-full"
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      브라우저 탭에 표시될 아이콘입니다. 32x32px 정사각형이
                      권장됩니다.
                    </p>
                  </div>
                  <div>
                      ...
                      <div className="border border-gray-200 rounded-lg">
                        ...
                        <div className="p-4">
                          <input
                            ...
                            placeholder={
                              footerTextLang === "ko"
                                ? "© 2024 LinkPick. All rights reserved."
                                : "© 2024 LinkPick. All rights reserved."
                            }
                          />
                        </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                <button
                                  ...
                                  onClick={() => {
                                    const newLinks =
                                      settings.website.footerLinks.filter(
                                        (_, i) => i !== index,
                                      );
                                    handleInputChange(
                                      "website",
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleInputChange("seo", "author", e.target.value)
                        }
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleInputChange("seo", "robots", e.target.value)
                        }
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleInputChange("seo", "canonical", e.target.value)
                        }
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange("metadata", "ogTitle", e.target.value)
                      }
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      placeholder="LinkPick - 인플루언서 마케팅 플랫폼"
                    />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleInputChange("metadata", "ogUrl", e.target.value)
                        }
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        placeholder="https://linkpick.com"
                      />
                  ...
                  <div>
                    ...
                    <div className="max-w-md">
                      <ImageUpload
                        ...
                        onChange={(value) =>
                          handleInputChange("metadata", "ogImage", value)
                        }
                        category="seo"
                        maxSize={5}
                        className="w-full"
                  ...
                  <div>
                    ...
                    <div className="max-w-md">
                      <ImageUpload
                        ...
                        onChange={(value) =>
                          handleInputChange("metadata", "twitterImage", value)
                        }
                        category="seo"
                        maxSize={5}
                        className="w-full"
                  ...
                  <div>
                    ...
                    <div className="max-w-md">
                      <ImageUpload
                        ...
                        onChange={(value) =>
                          handleInputChange("metadata", "favicon", value)
                        }
                        category="seo"
                        maxSize={1}
                        className="w-full"
                  ...
                  <div>
                    ...
                    <div className="max-w-md">
                      <ImageUpload
                        ...
                        onChange={(value) =>
                          handleInputChange("metadata", "appleTouchIcon", value)
                        }
                        category="seo"
                        maxSize={1}
                        className="w-full"
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      iOS 기기에서 북마크 시 표시되는 아이콘입니다. 180x180px
                      권장.
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-2">
                  {[
                    ...
                    <div key={type} className="flex items-center">
                      <input
                        type="checkbox"
                        checked={settings.content.allowedFileTypes.includes(
                          type,
                        )}
                        onChange={(e) => {
                          const currentTypes =
                            settings.content.allowedFileTypes;
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="flex items-center">
                  <input
                    ...
                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                  />
                  <label className="ml-2 text-sm text-gray-700">SMS 알림</label>
                </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-2">
                  HTML 태그를 사용할 수 있습니다. 변경사항은 저장 후 즉시
                  적용됩니다.
                </p>
              </div>
        ...
        {activeTab === "api" && (
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <p className="text-gray-600 mb-6">
              외부 서비스 API 키와 연동 정보를 관리합니다. 각 서비스의 API 키는
              안전하게 암호화되어 저장됩니다.
            </p>
            <ApiConfigSection />
          </div>
