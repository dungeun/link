              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div>
                  ...
                  <div className="flex items-center justify-between mb-3">
                    <span
                      className={`px-3 py-1 text-sm rounded-full ${getStatusColor(settlement.status)}`}
                    >
                  ...
                  {settlement.status === "pending" && (
                    <div className="flex space-x-2">
                      <button
                        onClick={() =>
                          handleStatusChange(settlement.id, "approved")
                        }
                      ...
                      <button
                        onClick={() =>
                          handleStatusChange(settlement.id, "rejected")
                        }
                  ...
                  {settlement.status === "approved" && (
                    <button
                      onClick={() =>
                        handleStatusChange(settlement.id, "completed")
                      }
