      ...
      try {
        ...
        setFormData({
          ...
          applicationStartDate: campaign.applicationStartDate
            ? new Date(campaign.applicationStartDate)
                .toISOString()
                .split("T")[0]
            : "",
          applicationEndDate: campaign.applicationEndDate
            ? new Date(campaign.applicationEndDate).toISOString().split("T")[0]
            : "",
          contentStartDate: campaign.contentStartDate
            ? new Date(campaign.contentStartDate).toISOString().split("T")[0]
            : "",
          contentEndDate: campaign.contentEndDate
            ? new Date(campaign.contentEndDate).toISOString().split("T")[0]
            : "",
          resultAnnouncementDate: campaign.resultAnnouncementDate
            ? new Date(campaign.resultAnnouncementDate)
                .toISOString()
                .split("T")[0]
            : "",
          announcementDate: campaign.announcementDate
            ? new Date(campaign.announcementDate).toISOString().split("T")[0]
            : "",
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          targetFollowers: Number(e.target.value),
                        })
                      }
                      className="mt-1"
                    />
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        contentStartDate: e.target.value,
                      })
                    }
                    className="mt-1"
                  />
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        resultAnnouncementDate: e.target.value,
                      })
                    }
                    className="mt-1"
                  />
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        campaignMission: e.target.value,
                      })
                    }
                    rows={3}
                    className="mt-1"
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        provisionDetails: e.target.value,
                      })
                    }
                    rows={3}
                    className="mt-1"
                      ...
                      {productImages.map((img, idx) => (
                        <div key={idx} className="relative group">
                          ...
                          <button
                            ...
                            onClick={() =>
                              setProductImages(
                                productImages.filter((_, i) => i !== idx),
                              )
                            }
