...
export default function BusinessApplicationsPage() {
  ...
  const handleStatusChange = async (
    ...
    try {
      const response = await apiPost(
        `/api/business/applications/${applicationId}/status`,
        {
          status,
        },
      );
  ...
  const filteredApplications = applications.filter((application) => {
    ...
    const matchesCampaign =
      filterCampaign === "all" || application?.campaignId === filterCampaign;
                    ...
                    >
                        ...
                        <div className="flex items-center">
                          ...
                          <div className="ml-4">
                            <div className="text-sm font-medium text-gray-900">
                              {application?.influencerName || "알 수 없음"}
                            </div>
                            <div className="text-sm text-gray-500">
                              @{application?.influencerHandle || "미설정"}
                            </div>
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-4">
                        <div className="text-sm text-gray-900">
                          {application?.campaignTitle || "알 수 없음"}
                        </div>
                      </td>
                      <td className="px-6 py-4">
                        <div className="text-sm text-gray-900">
                          {application?.followers?.toLocaleString() || "0"}
                        </div>
                      </td>
                      <td className="px-6 py-4">
                        <div className="text-sm text-gray-900">
                          {application?.engagementRate || 0}%
                        </div>
                      </td>
                      <td className="px-6 py-4">
                        <span
