      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <main className="container mx-auto px-4 sm:px-6 py-6 sm:py-8 flex-1">
          ...
          <div className="bg-white rounded-lg sm:rounded-xl shadow-sm p-6 mb-6 sm:mb-8">
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-4 sm:mb-6">{t('dashboard.quick_actions', '빠른 메뉴')}</h2>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              >
                ...
                <span className="text-sm font-medium text-gray-900 text-center">{t('dashboard.menu.campaigns', '캠페인 관리')}</span>
              </Link>
              ...
              >
                ...
                <span className="text-sm font-medium text-gray-900 text-center">{t('dashboard.menu.applications', '지원 내역')}</span>
              </Link>
              ...
              >
                ...
                <span className="text-sm font-medium text-gray-900 text-center">{t('dashboard.menu.payments', '정산 관리')}</span>
              </Link>
              ...
              >
                ...
                <span className="text-sm font-medium text-gray-900 text-center">{t('dashboard.menu.settings', '계정 설정')}</span>
              </Link>
            </div>
          </div>
