...
export default function PortfolioPage() {
  ...
  const [selectedPlatform, setSelectedPlatform] = useState<"all" | string>(
    "all",
  );
  const [sortBy, setSortBy] = useState<"recent" | "popular" | "engagement">(
    "recent",
  );
  ...
  const mockPortfolioItems: PortfolioItem[] = [
    {
      ...
      title: "여름 스킨케어 루틴 공유",
      description:
        "글로우 코스메틱 선크림과 수분크림을 활용한 여름 스킨케어 루틴을 소개합니다.",
      platform: "instagram",
      type: "image",
    ...
    },
    {
      ...
      title: "홈트레이닝 운동복 리뷰",
      description:
        "액티브 스포츠의 신제품 레깅스와 스포츠 브라 착용 리뷰입니다.",
      platform: "youtube",
      type: "video",
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <select
              value={sortBy}
              onChange={(e) =>
                setSortBy(e.target.value as "recent" | "popular" | "engagement")
              }
