                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                      {[
                        ...
                        >
                          <input
                            type="checkbox"
                            checked={apiSettings.languagePackSetup.languages.includes(lang.code)}
                            onChange={(e) => {
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                      선택된 언어: {apiSettings.languagePackSetup.languages.length}/3
                    </p>
                  </div>
                  ...
                  <div className="flex justify-end">
                    <button
                      onClick={() => {
                        if (apiSettings.languagePackSetup.languages.length !== 3) {
                        ...
                        if (confirm('선택한 언어로 설정하시겠습니까?\n\n' + 
                                   ...
                                   '선택된 언어: ' + apiSettings.languagePackSetup.languages.join(', '))) {
                          setApiSettings({
                            ...apiSettings,
                            languagePackSetup: {
                              ...apiSettings.languagePackSetup,
                      ...
                      disabled={apiSettings.languagePackSetup.languages.length !== 3}
