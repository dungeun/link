...
# JWT Secrets (임시 - 실제 운영시 변경 필요!)
vercel env add JWT_SECRET production <<< "your-super-secret-jwt-key-minimum-32-characters-2025-production"
vercel env add JWT_REFRESH_SECRET production <<< "your-super-secret-refresh-key-minimum-32-characters-2025-prod"
