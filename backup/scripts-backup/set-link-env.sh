...
# Link 프로젝트 Vercel 환경변수 설정 스크립트
echo "Setting environment variables for link project..."
...
vercel env add POSTGRES_URL production <<< "postgres://postgres.hibktfylqdamdzigznkt:68FBtj7P8d3MXS3H@aws-0-ap-northeast-2.pooler.supabase.com:6543/postgres?sslmode=require&supa=base-pooler.x"
vercel env add POSTGRES_USER production <<< "postgres"
vercel env add POSTGRES_HOST production <<< "db.hibktfylqdamdzigznkt.supabase.co"
vercel env add POSTGRES_PRISMA_URL production <<< "postgres://postgres.hibktfylqdamdzigznkt:68FBtj7P8d3MXS3H@aws-0-ap-northeast-2.pooler.supabase.com:6543/postgres?sslmode=require&pgbouncer=true"
vercel env add POSTGRES_PASSWORD production <<< "68FBtj7P8d3MXS3H"
vercel env add POSTGRES_DATABASE production <<< "postgres"
vercel env add POSTGRES_URL_NON_POOLING production <<< "postgres://postgres.hibktfylqdamdzigznkt:68FBtj7P8d3MXS3H@aws-0-ap-northeast-2.pooler.supabase.com:5432/postgres?sslmode=require"

# Supabase Configuration
vercel env add SUPABASE_URL production <<< "https://hibktfylqdamdzigznkt.supabase.co"
...
vercel env add SUPABASE_JWT_SECRET production <<< "5584DxxLcfjSfRStI1sfG1nG6148yaeDJ2tF0PEX5y1xIJ4MhwxNS+7903D00TcIVHiT7XkMLkdKfr4jh1bIZA=="
...
# Application URLs  
vercel env add NEXT_PUBLIC_API_URL production <<< "https://link-alpha-three.vercel.app"
vercel env add NEXT_PUBLIC_APP_URL production <<< "https://link-alpha-three.vercel.app"

echo "All environment variables have been set for link project!"